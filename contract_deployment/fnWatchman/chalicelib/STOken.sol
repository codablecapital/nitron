...
contract STOken is StandardToken, Ownable, Pausable {
    using SafeMath for uint256;

    mapping (address => bool) whitelist;
    mapping (address => bool) blacklist;

    uint256 initialSupply = [ISUPPLY];
    string public constant name = '[TOKENNAME]';
    string public constant symbol = '[TOKENSYMBOL]';
    uint8 public constant decimals = 18;
    address tokenCreator = address(0x[TOKENRECIVER]);
    uint private unlockTime = [UNLOCKTIME];
        ...
        public
    {
        ...
        balances[tokenCreator] = totalSupply_;
        emit Transfer(0x0, tokenCreator, totalSupply_);
    }
